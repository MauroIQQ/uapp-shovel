...
export const metadata = {
  title: `Visita Confirmada - ${config.name}`,
};
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-20">
      <div className="mx-auto max-w-md px-4 text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-3">¡Visita Confirmada!</h1>
        <p className="text-gray-600 mb-8">
          Tu solicitud se ha registrado con éxito. Te contactaremos para confirmar los detalles.
        </p>
