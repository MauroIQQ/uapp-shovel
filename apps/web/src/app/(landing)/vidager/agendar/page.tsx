...
export const metadata = {
  title: `Agendar Visita - ${config.name}`,
  description: `Agenda una visita en ${config.name} de forma rápida y sencilla.`,
};
    ...
    <div className="min-h-screen bg-gray-50 py-12 sm:py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">Agenda tu Visita</h1>
